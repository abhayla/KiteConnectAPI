...
namespace KiteConnectAPI
{
    ...
    {
        public SocketStateEventArgs(KiteConnectState kiteConnectState)
        {
            this.KiteConnectState = kiteConnectState;
        }

        /// <summary>
        /// Gets the kite connection state
        /// </summary>
        public KiteConnectState KiteConnectState { get; private set; }
    }
}
